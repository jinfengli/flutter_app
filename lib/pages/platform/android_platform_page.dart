...
class PageState extends State<AndroidPlatformPage> {
  ...
  static final String NATIVE_SHOW_TOAST = "showToast"; //原生android平台定义的供flutter端唤起的方法名
  ...
  static final EventChannel _EventChannel = EventChannel(EVENT_CHANNEL); //原生平台主动调用flutter端事件通道
